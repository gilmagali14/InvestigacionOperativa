...
const OrdenesDeCompra = () => {
    ...
    const estadosDisponibles = ['PENDIENTE', 'ACEPTADA', 'RECHAZADA']; // Definir los estados disponibles según tu lógica
    ...
    const handleChangeEstado = async (idOrden) => {
        try {
            ...
            // Actualizar localmente la orden con el nuevo estado
