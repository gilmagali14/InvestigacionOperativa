...
public interface OrdenCompraDetalleRepository extends JpaRepository<OrdenCompraDetalle, Long> {
    ...
    @Query("SELECT ocd FROM OrdenCompraDetalle ocd WHERE ocd.articuloProveedor.articulo.idArticulo = :articuloId")
    List<OrdenCompraDetalle> findByArticuloId(@Param("articuloId") Long articuloId);

    @Query("SELECT ocd FROM OrdenCompraDetalle ocd WHERE ocd.articuloProveedor.articulo.idArticulo = :articuloId and " +
    ...
    List<OrdenCompraDetalle> findByArticuloProveedor(ArticuloProveedor articulo);
